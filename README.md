...
* [Using methods](https://docs.madelineproto.xyz/docs/USING_METHODS.html)
  ...
  * [FULL API Documentation with descriptions](https://docs.madelineproto.xyz/API_docs/methods/)
    ...
    * <a href="https://docs.madelineproto.xyz/PHP/danog/MadelineProto/API.html#wrapmedia-array-media-danog-madelineproto-mtprototools-media" name="wrapMedia">Wrap a media constructor into an abstract Media object: wrapMedia</a>
