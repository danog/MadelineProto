...
interface Help
{
     ...
     */
    public function getAppUpdate(string|null $source = ''): array;
     ...
     */
    public function getAppChangelog(string|null $prev_app_version = ''): array;
     ...
     */
    public function setBotUpdatesStatus(int|null $pending_updates_count = 0, string|null $message = ''): bool;
     ...
     */
    public function getRecentMeUrls(string|null $referer = ''): array;
     ...
     */
    public function getDeepLinkInfo(string|null $path = ''): array;
     ...
     */
    public function getAppConfig(int|null $hash = 0): array;
     ...
     */
    public function getPassportConfig(int|null $hash = 0): array;
     ...
     */
    public function getUserInfo(array|int|string|null $user_id = null): array;
     ...
     * @return array{_: 'help.userInfoEmpty'}|array{_: 'help.userInfo', message: string, entities: list<array{_: 'messageEntityUnknown', offset: int, length: int}|array{_: 'messageEntityMention', offset: int, length: int}|array{_: 'messageEntityHashtag', offset: int, length: int}|array{_: 'messageEntityBotCommand', offset: int, length: int}|array{_: 'messageEntityUrl', offset: int, length: int}|array{_: 'messageEntityEmail', offset: int, length: int}|array{_: 'messageEntityBold', offset: int, length: int}|array{_: 'messageEntityItalic', offset: int, length: int}|array{_: 'messageEntityCode', offset: int, length: int}|array{_: 'messageEntityPre', offset: int, length: int, language: string}|array{_: 'messageEntityTextUrl', offset: int, length: int, url: string}|array{_: 'messageEntityMentionName', offset: int, length: int, user_id: int}|array{_: 'inputMessageEntityMentionName', offset: int, length: int, user_id: array|int|string}|array{_: 'messageEntityPhone', offset: int, length: int}|array{_: 'messageEntityCashtag', offset: int, length: int}|array{_: 'messageEntityUnderline', offset: int, length: int}|array{_: 'messageEntityStrike', offset: int, length: int}|array{_: 'messageEntityBlockquote', offset: int, length: int}|array{_: 'messageEntityBankCard', offset: int, length: int}|array{_: 'messageEntitySpoiler', offset: int, length: int}|array{_: 'messageEntityCustomEmoji', offset: int, length: int, document_id: int}>, author: string, date: int} @see https://docs.madelineproto.xyz/API_docs/types/help.UserInfo.html
     */
    public function editUserInfo(array|int|string|null $user_id = null, string|null $message = '', array $entities = [], \danog\MadelineProto\ParseMode $parse_mode = \danog\MadelineProto\ParseMode::TEXT): array;
     ...
     */
    public function hidePromoData(array|int|string|null $peer = null): bool;
     ...
     */
    public function dismissSuggestion(array|int|string|null $peer = null, string|null $suggestion = ''): bool;
     ...
     */
    public function getCountriesList(string|null $lang_code = '', int|null $hash = 0): array;
