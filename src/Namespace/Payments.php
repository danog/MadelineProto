...
interface Payments
{
     ...
     */
    public function getPaymentReceipt(array|int|string|null $peer = null, int|null $msg_id = 0): array;
     ...
     */
    public function validateRequestedInfo(array $invoice, array $info, bool|null $save = false): array;
     ...
     */
    public function sendPaymentForm(array $invoice, array $credentials, int|null $form_id = 0, string|null $requested_info_id = '', string|null $shipping_option_id = '', int|null $tip_amount = 0): array;
     ...
     */
    public function clearSavedInfo(bool|null $credentials = false, bool|null $info = false): bool;
     ...
     */
    public function getBankCardData(string|null $number = ''): array;
     ...
     */
    public function exportInvoice(\danog\MadelineProto\EventHandler\Media|array|string|null $invoice_media = null): array;
     ...
     */
    public function assignAppStoreTransaction(array $purpose, string|null $receipt = ''): array;
