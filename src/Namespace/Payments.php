...
interface Payments
{
     ...
     *
     * @param array{_: 'inputInvoiceMessage', peer: array|int|string, msg_id?: int}|array{_: 'inputInvoiceSlug', slug?: string} $invoice Invoice @see https://docs.madelineproto.xyz/API_docs/types/InputInvoice.html
     * @param array{_: 'inputPaymentCredentialsSaved', id?: string, tmp_password?: string}|array{_: 'inputPaymentCredentials', data: array{_: 'dataJSON', data?: string}, save?: bool}|array{_: 'inputPaymentCredentialsApplePay', payment_data: array{_: 'dataJSON', data?: string}}|array{_: 'inputPaymentCredentialsGooglePay', payment_token: array{_: 'dataJSON', data?: string}} $credentials Payment credentials @see https://docs.madelineproto.xyz/API_docs/types/InputPaymentCredentials.html
     ...
     *
     * @param array{_: 'dataJSON', data?: string} $receipt Any JSON-encodable data
     * @param array{_: 'inputStorePaymentPremiumSubscription', restore?: bool}|array{_: 'inputStorePaymentGiftPremium', user_id: array|int|string, currency?: string, amount?: int} $purpose Payment purpose @see https://docs.madelineproto.xyz/API_docs/types/InputStorePaymentPurpose.html
     * @return array @see https://docs.madelineproto.xyz/API_docs/types/Updates.html
     */
    public function assignPlayMarketTransaction(array $receipt, array $purpose): array;
