...
interface Photos
{
     ...
     */
    public function updateProfilePhoto(bool|null $fallback = false, array|int|string|null $bot = null, array|null $id = null): array;
     ...
     * @return array{_: 'photos.photo', photo: array{_: 'photoEmpty', id: array}|array{_: 'photo', has_stickers: array, id: array, access_hash: array, file_reference: array, date: array, sizes: list<array>, video_sizes: list<array>, dc_id: array}, users: list<array|int|string>} @see https://docs.madelineproto.xyz/API_docs/types/photos.Photo.html
     */
    public function uploadProfilePhoto(bool|null $fallback = false, array|int|string|null $bot = null, mixed $file = null, mixed $video = null, float|null $video_start_ts = 0.0, array|null $video_emoji_markup = null): array;
     ...
     * @return list<int>
     */
    public function deletePhotos(array $id = []): array|null;
     ...
     */
    public function getUserPhotos(array|int|string|null $user_id = null, int|null $offset = 0, int|null $max_id = 0, int|null $limit = 0): array;
     ...
     * @return array{_: 'photos.photo', photo: array{_: 'photoEmpty', id: array}|array{_: 'photo', has_stickers: array, id: array, access_hash: array, file_reference: array, date: array, sizes: list<array>, video_sizes: list<array>, dc_id: array}, users: list<array|int|string>} @see https://docs.madelineproto.xyz/API_docs/types/photos.Photo.html
     */
    public function uploadContactProfilePhoto(bool|null $suggest = false, bool|null $save = false, array|int|string|null $user_id = null, mixed $file = null, mixed $video = null, float|null $video_start_ts = 0.0, array|null $video_emoji_markup = null): array;
}
