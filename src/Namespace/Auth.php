...
interface Auth
{
     ...
     *
     * @param list<int> $except_auth_keys The auth keys that **shouldn't** be dropped.
     */
     ...
     * @param list<int> $except_ids List of already logged-in user IDs, to prevent logging in twice with the same user
