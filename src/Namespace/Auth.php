...
interface Auth
{
     ...
     * @param ?string $queueId If specified, ensures strict server-side execution order of concurrent calls with the same queue ID.
     * @param ?\Amp\Cancellation $cancellation Cancellation
     * @return array{_: 'auth.firebasePnvIntent', nonce: string, digital_credential_payload: string} @see https://docs.madelineproto.xyz/API_docs/types/auth.FirebasePnvIntent.html
     * @psalm-impure
     */
    public function initFirebasePnvLogin(int|null $api_id = 0, string|null $api_hash = '', ?int $floodWaitLimit = null, ?string $queueId = null, ?\Amp\Cancellation $cancellation = null): array;
     ...
     * @psalm-impure
     */
    public function finishFirebasePnvLogin(string|null $google_token = '', ?int $floodWaitLimit = null, ?string $queueId = null, ?\Amp\Cancellation $cancellation = null): array;

    /**
     * 
     *
     * @param bool $no_joined_notifications 
     ...
     * @psalm-impure
     */
    public function firebasePnvSignUp(bool|null $no_joined_notifications = null, string|null $first_name = '', string|null $last_name = '', ?int $floodWaitLimit = null, ?string $queueId = null, ?\Amp\Cancellation $cancellation = null): array;
}
