...
interface Auth
{
     ...
     * @param ?\Amp\Cancellation $cancellation Cancellation
     */
    public function requestFirebaseSms(string|null $phone_number = '', string|null $phone_code_hash = '', string|null $safety_net_token = '', string|null $ios_push_secret = '', ?int $floodWaitLimit = null, ?string $queueId = null, ?\Amp\Cancellation $cancellation = null): bool;
