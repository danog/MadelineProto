...
interface Stats
{
     ...
     */
    public function getBroadcastStats(bool|null $dark = false, array|int|string|null $channel = null): array;
     ...
     */
    public function loadAsyncGraph(string|null $token = '', int|null $x = 0): array;
     ...
     */
    public function getMegagroupStats(bool|null $dark = false, array|int|string|null $channel = null): array;
     ...
     */
    public function getMessagePublicForwards(array|int|string|null $channel = null, int|null $msg_id = 0, int|null $offset_rate = 0, array|int|string|null $offset_peer = null, int|null $offset_id = 0, int|null $limit = 0): array;
     ...
     */
    public function getMessageStats(bool|null $dark = false, array|int|string|null $channel = null, int|null $msg_id = 0): array;
}
