...
final class Lang
{
    public static array $lang = [
        ...
        [
            ...
            'do_not_use_blocking_class' => 'for performance reasons, plugins may not use the non-async blocking class %s, please use %s, instead',
            'do_not_use_blocking_function' => 'for performance reasons, plugins may not use the non-async blocking function %s, please use %s, instead',
            ...
            'must_have_declare_types' => 'for performance reasons, the first statement of a plugin must be declare(strict_types=1);',
