 ...
 * Allow all contacts.
 */
final readonly class AllowContacts extends RuleDestination
{
    /**
     * @internal
     */
    ...
    {
        ConstructorAssertion::assert($rawRule, 'privacyValueAllowContacts');
    }

    public static function new(): self
    {
        return new static(['_' => 'privacyValueAllowContacts']);
    }
