 ...
 */
final readonly class AllowBots extends RuleDestination
{
    /**
     * @internal
     */
    ...
    {
        ConstructorAssertion::assert($rawRule, 'privacyValueAllowBots');
    }

    public static function new(): self
    {
        return new static(['_' => 'privacyValueAllowBots']);
    }
