 ...
 */
final class TodoItemsTooMuchError extends RPCErrorException
{
    protected function __construct(int $code, string $caller, ?\Exception $previous = null)
    {
        parent::__construct('TODO_ITEMS_TOO_MUCH', 'You specified too many todo list items.', $code, $caller, $previous);
    }
}
