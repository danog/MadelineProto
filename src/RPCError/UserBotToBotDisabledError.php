...
/**
 * UserBotToBotDisabledError error.
 *
 ...
 */
final class UserBotToBotDisabledError extends RPCErrorException
{
    protected function __construct(int $code, string $caller, ?\Exception $previous = null)
    {
        parent::__construct('USER_BOT_TO_BOT_DISABLED', 'Bot-to-bot messaging is disabled because one of the two bots hasn\'t enabled the Bot to Bot setting in @BotFather.', $code, $caller, $previous);
    }
}
