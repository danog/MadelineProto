...
final class Magic
{
    ...
    public static function start(bool $light): void
    {
        ...
        foreach (['xml', 'dom', 'fileinfo', 'json', 'filter', 'hash', 'zlib'] as $extension) {
        ...
        self::$fieldPrime = new BigInteger('7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffed', 16);
