...
/**
     ...
     * @param boolean $need_debug Need debug?
      * @return mixed
     */
    public function discardCall(array $call, array $reason, array $rating = array (
     ...
     * @param null|string $name Name of file to download, required for bot API file IDs.
      * @return mixed
     */
    public function downloadToBrowser(\danog\MadelineProto\FileCallbackInterface|array|string $messageMedia, ?callable $cb = null, ?int $size = null, ?string $name = null, ?string $mime = null)
    {
     ...
     * @param string $file  File where the message originated
      * @return mixed
     */
    public function logger(mixed $param, int $level = \danog\MadelineProto\Logger::NOTICE, string $file = '')
    {
     ...
     * @param array             $aargs  Additional arguments
      * @return 
     */
    public function methodCall(string $method, callable|array $args = array (
    ), array $aargs = array (
      'msg_id' => null,
    ))
    {
     ...
     * @param array             $aargs  Additional arguments
      * @return 
     */
    public function methodCallWrite(string $method, callable|array $args = array (
    ), array $aargs = array (
      'msg_id' => null,
    ))
    {
     ...
     * @param mixed $id The peer to refresh
      * @return mixed
     */
    public function refreshFullPeerCache(mixed $id)
    {
     ...
     * @param mixed ...$id The peer(s) to refresh
      * @return mixed
     */
    public function refreshPeerCache(mixed ...$ids)
    {
     ...
     * @param int|string|array<int|string> $userOrId Username(s) or peer ID(s)
      * @return mixed
     */
    public function setReportPeers(array|string|int $userOrId)
    {
     ...
     * @param SettingsAbstract $settings Settings
      * @return mixed
     */
    public function updateSettings(\danog\MadelineProto\SettingsAbstract $settings)
    {
