...
$MadelineProto->[messages_forwardMessages](messages_forwardMessages.md)(\['peer' => [InputPeer](../types/InputPeer.md), 'id' => \[[int](../types/int.md)\], \]) == [$Updates](../types/Updates.md)<a name="messages_forwardMessages"></a>  
...
$MadelineProto->[messages_sendMedia](messages_sendMedia.md)(\['peer' => [InputPeer](../types/InputPeer.md), 'reply_to_msg_id' => [int](../types/int.md), 'media' => [InputMedia](../types/InputMedia.md), \]) == [$Updates](../types/Updates.md)<a name="messages_sendMedia"></a>  
