...
<amp-form method="GET" target="_top" action="https://docs.madelineproto.xyz/docs/FEATURES.html"><input type="submit" value="Previous section" /></form><amp-form action="https://docs.madelineproto.xyz/docs/INSTALLATION.html" method="GET" target="_top"><input type="submit" value="Next section" /></form>