...
Use [`request_secret_chat`] requests a secret secret chat to the [InputUser](https://daniil.it/MadelineProto/API_docs/types/InputUser.html) specified, and returns the secret chat ID.
