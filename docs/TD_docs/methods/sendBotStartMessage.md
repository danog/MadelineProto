...
|----------|---------------|----------|-------------|
|bot\_user\_id|[CLICK ME int](../types/int.md) | Yes|Identifier of the bot|
|chat\_id|[CLICK ME int53](../types/int53.md) | Yes|Identifier of the chat|
|parameter|[CLICK ME string](../types/string.md) | Yes|Hidden parameter sent to bot for deep linking (https: api.telegram.org/bots#deep-linking)|
