...
```
$updates_channelDifference = ['_' => 'updates_channelDifference', 'final' => true, 'channel_pts' => int, 'timeout' => int, 'new_messages' => [Vector t], 'other_updates' => [Vector t], 'chats' => [Vector t], 'users' => [Vector t], ];
```  
